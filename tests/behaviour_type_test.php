...
/**
 * Unit tests for the MooPT interactive with multiple tries behaviour type class.
 *
...
class behaviour_type_test extends \basic_testcase {
    ...
    /** @var qbehaviour_interactivemoopt_type */
    protected $behaviourtype;

    public function setUp(): void {
        parent::setUp();
        $this->behaviourtype = question_engine::get_behaviour_type('interactivemoopt');
    }
